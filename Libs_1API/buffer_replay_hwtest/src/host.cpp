...
int main(int argc, char* argv[]) {
  ...
  try {
    ...
    //   std::cout << "WARN: The selected device does not support USM host"
    //             << " allocations\n";
    //   // std::terminate();
    // }
    ...
    //   h.single_task<Itm1>([=]() {
      ...
      //   intel::numbanks(1)]]
      //   fixed_l1 TLev[Lev1_Width];
      //   // initialize on-chip memory
      //   for (size_t j=0;j<Lev1_Width;j++){
      //       TLev[j]=0;
      //   }
    ...
    //   h.single_task<Itm2>([=]() {
      ...
      //   intel::fpga_memory("MLAB"),
      //   intel::numbanks(1)]]
      //   fixed_l2 TLev[Lev2_Width];
      //   // initialize on-chip memory
      //   for (size_t j=0;j<Lev2_Width;j++){
      //       TLev[j]=0;
      //   }
    ...
    //   h.single_task<Itm3>([=]() {
        ...
        // intel::fpga_memory("MLAB"),
        // intel::numbanks(1)]]
        // fixed_l3 TLev[Lev3_Width];
        // // Initialize on-chip memory
        // for (size_t j=0;j<Lev3_Width;j++){
        //     TLev[j]=0;
        // }
